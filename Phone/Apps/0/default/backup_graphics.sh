...
# This script is meant to copy all Graphic files from MIB and backup the original ones
# author: Superkolos
########################

#info
TOPIC=Graphics
DESCRIPTION="This script will backup original Graphic files on your SD."
